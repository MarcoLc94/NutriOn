      ...
      <div className="footer-content">
        <div className="footer-section">
          ...
          <p className="footer-text">
            Nutrición personalizada que transforma planes en comidas listas para disfrutar.
          </p>
        </div>
        ...
        <div className="footer-section">
          ...
          <ul className="footer-contact">
            <li className="footer-contact-item">
              <span className="material-symbols-outlined">mail</span> info@nutrion.com
            </li>
            <li className="footer-contact-item">
              <span className="material-symbols-outlined">call</span> +52 00 0000 0000
            </li>
            <li className="footer-contact-item">
              <span className="material-symbols-outlined">location_on</span> Mty, México
            </li>
          </ul>
        </div>
      </div>
